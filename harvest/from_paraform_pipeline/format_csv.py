...
with open('/Users/yashbhavsar/Code/job-search-help/tmp/getAllRoles.json', 'r') as f:
    data = json.load(f)
...
output_csv = '/Users/yashbhavsar/Code/job-search-help/paraform_all_jobs.csv'
with open(output_csv, 'w', newline='', encoding='utf-8') as csvfile:
    writer = csv.writer(csvfile)
    writer.writerow(['ID', 'Company', 'Title', 'Salary Min', 'Salary Max', 'Location'])
    ...
    for r in roles:
        ...
        writer.writerow([role_id, company, title, salary_min, salary_max, loc_str])
